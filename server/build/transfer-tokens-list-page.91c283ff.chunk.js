"use strict";
(self["webpackChunkserver"] = self["webpackChunkserver"] || []).push([[9600],{
...
const LinkStyled = (0,styled_components_browser_esm/* default */.ZP)((0,dist/* Link */.rU))`
  svg {
    path {
...
const TransferTokenListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(dist/* SettingsPageTitle */.SL, { name: "Transfer Tokens" }), /* @__PURE__ */ react.createElement(
...
const ProtectedTransferTokenListView = () => {
  const permissions = (0,es/* useSelector */.v9)(selectors/* selectAdminPermissions */._);
  return /* @__PURE__ */ react.createElement(dist/* CheckPagePermissions */.O4, { permissions: permissions.settings["transfer-tokens"].main }, /* @__PURE__ */ react.createElement(ListView, null));
};
